...
puts "making trades"
  ...
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:6000, quantity:10)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:6000, quantity:7)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:6000, quantity:10)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:7000, quantity:10)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:8000, quantity:10)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:2000, quantity:10)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:3000, quantity:10)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:5000, quantity:5)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:6000, quantity:10)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:6000, quantity:7)
  Trade.create(user_id:User.all.first.id, asset_id:Asset.find_by(name: "Ethereum").id, buy:true, price:6000, quantity:10)
